...
cibernéticas, \textit{firewall} ~\cite{Last:2016}. Outras maneiras de prevenção seria por meio de \texit{Host Intrusion Protected 
Software} (HIPS), em que não se depende de assinaturas, já que há um monitoramente das atividades da máquina, usar um bom antivírus  
...
% colocar mais geral o objetivo com relação as fontes
% colocar recursos necessários
% arrumar a justificativa
% colocar e dividir os paragráfos 
